...
- Der Oblat (Empfänger des Angebots) kann nur innerhalb dieser gegebenen Frist annehmen.  
- Der Anbieter ist bis zum Ablauf der Frist gebunden.

**Ohne Frist:**
Hier unterscheidet man:

Mündliches Angebot (unter Anwesenden)
- Muss sofort angenommen werden  
- Sonst erlischt es direkt

Schriftliches Angebot (unter Abwesenden)
Gilt für eine „angemessene Zeit“  
Diese setzt sich zusammen aus:
- Übermittlungszeit
- Überlegungszeit
- Rückübermittlungszeit
Beispiel: Brief oder E-Mail → einige Tage (je nach Situation)

Angebotsfristen können aber auch verkürzt werden, wenn eine Vorinformation mindestens 35 Tage und höchstens 12 Monate vor der Auftragsbekanntmachung erfolgte oder dringende Gründe vorliegen.
___

was ist die bindungswirkung einer willenserklärung?
**Bindungswirkung:** bezeichnet die rechtliche Verbindlichkeit einer Entscheidung, Erklärung oder Regelung für bestimmte Personen, Stellen oder Verfahren.
was es bringt:
- verlässligkeit
- verhindert wiedersprüche
- ermöglicht planbares handeln im rechtssystem
