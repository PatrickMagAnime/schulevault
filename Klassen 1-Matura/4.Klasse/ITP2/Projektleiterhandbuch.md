...
```mermaid
gantt
  title Projektbalkenplan – Gartenhütte mit Keller + WC
  dateFormat  YYYY-MM-DD
  axisFormat  %d.%m.%Y

  section Management
  Kick-off & Setup            :m1, 2025-11-01, 5d
  Genehmigungen               :mg1, 2025-11-01, 21d
  Vergabe/Auswahl Gewerke     :mg2, 2025-11-20, 14d

  section Tiefbau/Keller
  Baustelleneinrichtung       :tb0, 2025-12-05, 3d
  Erdarbeiten/Aushub          :tb1, 2025-12-08, 10d
  WU-Beton Boden/Wände        :tb2, after tb1, 12d
  Abdichtung/Drainage         :tb3, after tb2, 7d
  Kellerdecke                 :tb4, after tb3, 5d

  section Aufbau Hütte
  Holzrahmenbau Rohbau        :hb1, 2026-02-15, 10d
  Fassade/Fenster/Tür         :hb2, after hb1, 7d
  Dachkonstruktion/Abdichtung :hb3, after hb1, 7d

  section TGA/Innen
  Elektro (Zuleitung/UV/Elt)  :tga1, 2026-03-25, 7d
  Sanitär (Zulauf/Abwasser/WC):tga2, 2026-04-05, 7d
  Innenausbau                 :ia1, 2026-04-20, 15d

  section Abschluss
  Prüfungen/Protokolle        :ab1, 2026-05-25, 3d
  Abnahme/Übergabe            :milestone, m8, 2026-05-31, 1d
```
...
```mermaid
flowchart LR
  AG[Auftraggeber/PL<br/>Patrick Riedl]
  PROJ[Projekt: Gartenhütte + Keller + WC]
  BA[Bauamt]
  NA[Nachbarn]
  WS[Wasserversorger]
  ABW[Abwasserbetrieb]
...
flowchart TD
  ...
  A1[1.1 Setup/Kick-off]
  A2[1.2 Genehmigungen]
  A3[1.3 Vergabe]
  A4[1.4 Controlling]
  A5[1.5 Prüfungen/Abnahme/Doku]

  B[2 Tiefbau/Keller]
  B1[2.1 Einrichtung/Vermessung]
  B2[2.2 Aushub/Entsorgung]
  B3[2.3 Keller WU‑Beton]
  B4[2.4 Abdichtung/Drainage]
  B5[2.5 Kellerdecke]

  C[3 Aufbau Hütte]
  C1[3.1 Holzrahmenbau]
  C2[3.2 Fassade/Fenster/Tür/Holzschutz]
  C3[3.3 Dach/Abdichtung/Rinne]
  C4[3.4 Elektro]
  C5[3.5 Sanitär/WC/Hebeanlage]
  C6[3.6 Innenausbau]

  D[4 Abschluss]
  D1[4.1 As‑Built/Abnahme/Übergabe]
...
```mermaid
timeline
  title Meilensteine (Plan)
  2025-11-01 : M1 Genehmigung/Startfreigabe
  2025-12-20 : M2 Aushub abgeschlossen
  2026-01-31 : M3 Keller inkl. Decke fertig
  2026-03-05 : M4 Holzbau-Rohbau steht
  2026-03-31 : M5 Dach regendicht
  2026-05-03 : M6 TGA-Rohmontage fertig
  2026-05-30 : M7 Innenausbau abgeschlossen
  2026-05-31 : M8 Gesamtfertigstellung/Abnahme
```
...
```mermaid
flowchart LR
  PL[Projektleiter<br/>Patrick Riedl]
  AG[Auftraggeber<br/>Patrick Riedl]
  G1[Tiefbau]
  G2[Betonbau]
  G3[Holzbau]
  G4[Dach]
  G5[SHK]
  G6[Elektro]
  CO[Controlling-Meeting<br/>14-tägig]
  AGM[AG-Meeting<br/>monatlich]
  KOO[Gewerkekoordination<br/>wöchentlich]
  DOC[Doku/Protokolle]
...
flowchart TB
  subgraph High[Auswirkung: Hoch]
    direction LR
    HH[A/H: WU‑Beton Undichtigkeiten<br/>Priorität: hoch]
    HK[A/H: Grundwasser hoch<br/>Priorität: hoch]
  end
  subgraph Medium[Auswirkung: Mittel]
    direction LR
    MM1[M/M: Witterung Holzbau<br/>Priorität: mittel]
    MM2[M/M: Dichtigkeitsmangel Dach<br/>Priorität: mittel]
    MM3[M/M: Lieferverzug Abdichtung<br/>Priorität: mittel]
    MM4[M/M: Baustrom verspätet<br/>Priorität: mittel]
    MM5[M/M: Hebeanlagen-Anpassung<br/>Priorität: mittel]
  end
  subgraph Low[Auswirkung: Niedrig]
    direction LR
    LL[L/N: Prüfprotokolle unvollständig<br/>Priorität: niedrig]
  end
...
stateDiagram-v2
  [*] --> Vorabprüfungen
  Vorabprüfungen --> Prüfprotokolle_vollständig: Checklisten ok
  Vorabprüfungen --> Nacharbeit: Mängel festgestellt
  Nacharbeit --> Vorabprüfungen: Korrekturen erledigt
  Prüfprotokolle_vollständig --> Abnahmebegehung
  Abnahmebegehung --> Restpunkte
  Restpunkte --> Abnahmebegehung: Erledigt
  Abnahmebegehung --> Abnahmeprotokoll_unterschrieben
  Abnahmeprotokoll_unterschrieben --> Übergabe/Archivierung
