...
1. **Bewusstsein schaffen**: Informationssicherheit ist mehr als Technik → organisatorische, technische, personelle, infrastrukturelle Aspekte.  
2. **Werte & Prozesse kennen**: Schutzbedarf und Risiken analysieren, Strategie festlegen.  
3. **Informationssicherheit als Prozess verstehen**: fortlaufende Überprüfung & Verbesserung durch ein **Managementsystem für Informationssicherheit (ISMS)**.  
